...
_SOCKETEVENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
        name='challenge_reply_error_type',
        full_name='extensions.api.cast_channel.proto.SocketEvent.challenge_reply_error_type', index=10,
...
_AGGREGATEDSOCKETEVENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
        name='channel_auth_type', full_name='extensions.api.cast_channel.proto.AggregatedSocketEvent.channel_auth_type',
        index=2,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
        name='bytes_written', full_name='extensions.api.cast_channel.proto.AggregatedSocketEvent.bytes_written',
        index=5,
...
_LOG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
        name='aggregated_socket_event', full_name='extensions.api.cast_channel.proto.Log.aggregated_socket_event',
        index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
        name='num_evicted_aggregated_socket_events',
        full_name='extensions.api.cast_channel.proto.Log.num_evicted_aggregated_socket_events', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
        name='num_evicted_socket_events', full_name='extensions.api.cast_channel.proto.Log.num_evicted_socket_events',
        index=2,
